...
public enum WifiService {
    ...
    public void register(WifiDTO wifiDTO) {
        System.out.println("DEBUG......." + wifiDTO);
    }

    public List<WifiDTO> getList() {

        return IntStream.rangeClosed(0, 10).mapToObj(i -> {
            WifiDTO wifiDTO = new WifiDTO(i, i);
            return wifiDTO;
    ...
    public void test() throws IOException {
        ...
        /*URL*/
        urlBuilder.append("/" + URLEncoder.encode("515a524e6f6f74773834526e586d58", "UTF-8")); /*인증키
